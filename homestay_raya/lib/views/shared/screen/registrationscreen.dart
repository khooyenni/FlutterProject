  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Center(
          ...
          child: Column(
            children: [
              Image.asset('assets/images/register1.png', scale: 1),
              Card(
                elevation: 8,
                        ...
                        children: [
                          ...
                          Flexible(
                            child: GestureDetector(
                              onTap: showEula,
                              child: const Text('Agree with terms & conditions',
                                  style: TextStyle(
                                    fontSize: 16,
  ...
  String? validatePassword(String value) {
    ...
    if (value.isEmpty) {
      ...
      if (!regex.hasMatch(value)) {
        return 'Password must contain at least 1 capital letter, 1 small letter, 1 number and the minimum length of 10 characters';
      } else {
        return null;
      }
    }
