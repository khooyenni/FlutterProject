...
class CustomerHomestayDetails extends StatefulWidget {
  final Homestay homestay;
  final User user;
  final User seller;
  CustomerHomestayDetails(
      {super.key,
  ...
  @override
  State<CustomerHomestayDetails> createState() =>
      _CustomerHomestayDetailsState();
}

class _CustomerHomestayDetailsState extends State<CustomerHomestayDetails> {
      ...
      body: Column(children: [
        ...
        Text(
          ...
          style: const TextStyle(
              ...
              color: Color.fromARGB(255, 4, 3, 85)),
        ),
        const SizedBox(
          height: 20,
        ),
              ...
              children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Price/Per Night', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('No of Rooms', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("${widget.homestay.homestayQtyroom}",
                            style: const TextStyle(fontSize: 20.0))
                      ]),
                ]),
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Locality', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                ...
                TableRow(children: [
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: const [
                        Text('Owner', style: TextStyle(fontSize: 20.0, fontWeight: FontWeight.bold))
                      ]),
                  Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
